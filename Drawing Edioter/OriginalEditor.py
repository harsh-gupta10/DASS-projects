...
class DrawingEditor:
    ...
    def create_toolbar(self):
        ...
        export_button = tk.Button(toolbar, text="Export XML", command=self.export_as_xml)
    ...
    def load_drawing(self, file_path=None):
        ...
        if file_path:
            ...
            if file_path.endswith(".xml"):
                ...
                self.import_from_xml(file_path)  # This line should call the import_from_xml function
            else:
                # Loading from non-XML file types
                with open(file_path, "r") as file:
                    for line in file:
                        # Parsing non-XML file content
